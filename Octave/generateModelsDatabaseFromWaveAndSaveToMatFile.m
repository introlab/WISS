function modelsDatabase = generateModelsDatabaseFromWaveAndSaveToMatFile(fileNameList, fileNameDatabase)
%
% *************************************************************************
% *                                                                       *
% * Project: WISS                                                         *
...
% ************************************************************************* 
% *                                                                       *
% * Inputs:  fileNameList     List of file paths of wave and model names  *
...
% * fileNameList{1,2} = '(path of the wave file used for training speaker *
% *                     1)'                                               *
% * fileNameList{2,1} = '(string id for speaker 2)'                       *
% * fileNameList{2,2} = '(path of the wave file used for training speaker *
% *                     2)'                                               *
% *        ...        =                          ...                      *
% * fileNameList{N,1} = '(string id for speaker N)'                       *
% * fileNameList{N,2} = '(path of the wave file used for training speaker *
% *                     N)'                                               *
% *                                                                       *
...
% 
    ...
    % Save to file
    saveDatabaseToMatFile(modelsDatabase, fileNameDatabase)
